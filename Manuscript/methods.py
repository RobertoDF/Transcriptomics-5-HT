...
methods = {"Jupyter notebooks structure": "The entire analysis is contained in 2 jupyter notebooks hosted on Github at https://github.com/RobertoDF/Transcriptomics-5-HT. "
            ...
            "Data preparation":             "We loaded the metadata and the precomputed expression matrices for the scRNA-seq dataset relative to all Htr genes "
                                                      ...
                                                      "this is necessary because some cells belong to multiple 'cluster_group_name' and therefore causes a doubling of some rows. "
            ...
            "Overview figure": "This figure relies uniquely on the scRNA-seq dataset. "
                                                      ...
                                                      "contained in the dataset. In panel B we used the precomputed UMAP coordinates and plotted on the color axis information about the "
                                                      "most transcribed gene per selected family. \n"
                                                      "In panel C and D we plotted the percentage of cells transcribing each Htr grouped by neurotransmitter release. We take advantage of the pandas 'Group by' "
