...
methods = {"Data and code availability": "The entire analysis is hosted on Github at https://github.com/RobertoDF/Transcriptomics-5-HT and 10.6084/m9.figshare.26325505. "
                                          ...
                                          "Data is downloaded "
                                          "following the instructions provided by the Allen Institute (# point to your aws installation see (https://github.com/AllenInstitute/abc_atlas_access/blob/ecd803247b2c2dfa3ce2297880c9cfbf8c79cfab/notebooks/getting_started.ipynb)), "
            ...
            "Receptor figure":  "This figure relies on both the scRNA-seq and MERFISH datasets. "
                                                             ...
                                                             "We excluded from the analysis the 'NN-IMN-GC' neighborhood because of consistently low transcription across all Htr genes. For the visualization "
                                                              ...
                                                              "To visualize the number of colocalized genes (bar plot on the right), we utilized a boolean dataframe ('joined_boolean') to"
           ...
           "Data Visualizer":   "The visualizer was built in Python using Matplotlib, Holoviews and Panel libraries. It is available as a jupyter notebook ('Figures/Interactive_vizs.ipynb') "
                                ...
                                "1. Line plot representing the proportion of cells selected across the spatial axis associated to each dataset, "
                                "2. Line plot representing the amount of transcription across space of the selected gene, 3. Line plot representing the percentage of "
                                "cells across space in which RNA of "
                                f"the selected gene was detected (threshold set at {threshold_expression_MERFISH }), 4. Bar plot representing the percentage "
                                ...
                                "group and gene. For each class of neurons, three levels of visualization are provided: 1. Violin plots: Gene prevalence by subclass, "
                                "2.Violin plots: Prevalence by supertype, 3. Bar plots: Prevalence by cluster. \n"
