...
methods = {"Jupyter notebooks structure": "The entire analysis is contained in 2 jupyter notebooks hosted on Github at https://github.com/RobertoDF/Transcriptomics-5-HT. "
            ...
            "Overview figure": "This figure relies uniquely on the scRNA-seq dataset. "
                                                     ...
                                                     "\nIn panel B we used the precomputed UMAP coordinates available in the 'joined' dataframe and plotted on the color axis information about the "
                                                      ...
                                                      "In panel C and D we plotted the percentage of cells transcribing each Htr grouped by neurotransmitter release. "
                                                      ...
                                                      "The confusion matrix is computed within the 'decodddit' function in 'Figure_1.ipynb'. "
                                                     "Here we use a boolean version of the 'joined' dataframe created using "
                                                      ...
                                                      "The features for classification were defined as the boolean expression of the various 5-HT receptor genes, and the target variable was "
                                                      ...
                                                      "Forest classifier was initialized with parameters set to 200 decision trees and a maximum tree depth of 10. "
                                                     "The classifier was configured to handle class imbalances by adjusting the class weights. The model "
                                                      ...
                                                      "jobs was set to 40 to leverage computational resources effectively. The SHAP values were computed for a sample of the feature set "# TODO rewrite the decoding part
