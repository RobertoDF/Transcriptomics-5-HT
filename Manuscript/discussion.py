...
discussion = ("In this work we described the main transcriptional features of each Htrs across the entire brain leveraging two datasets provided by {Yao, 2023 #2828} and {Zhang, 2023 #2887}. "
              ...
              "This lack of specificity becomes particularly problematic, for example, in the context of Sero neurons, which have extensive projections throughout the brain and exhibit diverse autoreceptors. "
