...
results = {"Htrs transcription overview":
               ...
               "as neurotransmitter-release {Yao, 2023 #2828}, offer a condensed categorization of cell types (Figure S1B, Table 1). "
               ...
               "neurotransmitter, neighborhood or class (Figure S1B). The totality of cells were divided in 34 classes (as defined in {Yao, 2023 #2828}). "
           ...
           "Htr1 & Htr5": u"Receptors belonging to these two families have an inhibitory effect on the host cell, they are coupled to G\u1D62 and cause a downstream decrease of cAMP "
                          ...
                          f"RNA-seq dataset, 3453 PAG-PPN Pax5 Sox21 Gaba. This cluster was located mainly in the midbrain reticular nucleus (RR, Figure S6D-E). "
