...
results = {"Htrs transcription overview":
               ...
               "The RNA-seq dataset comprehensively encompassed all known 14 Htr subtypes. "
               ...
               f"All the other neurotransmitter were found in less than 1% of the cells, "
               ...
               f"Chol={round(cm_neurotransmitter['Chol']['Chol'], 2)}%). Cells not transcribing any neurotranmitter, not exhibiting a low r beforehand, were, "
               ...
               f"When looking at different neighborhoods the accuracy of the model was {round(accuracy_neighborhood,2)}%. "
               ...
               f"with a TP rate >40%: {formatted_class_string} (Supplementary Figure 3B). 04 DG-IMN Glut were characterized by high transcription of Htr4 and absence of "
           ...
           "Htr1 & Htr5": u"Receptors belonging to these two families have an inhibitory effect on the host cell, they are coupled to G\u1D62 and cause a downstream decrease of cAMP "
                          ...
                          "contained most of the cortical cells transcribing Htr1a (see online visualizer, 'Overview genes by class'). "
                          ...
                          f"pointing at a relatively low importance of this receptor in the clustering algorithm. "
                          ...
                          f"Also in this case, 01 IT-ET Glut exhibited the highest absolute number of Htr1b expressing cells, specifically, in a subclass "
           ...
           "Htr2": "The Htr2 family is mainly linked to Gq/11 and causes depolarization by increasing intracellular Ca2+. Htr2a, instrumental in mediating the effects of psychedelics {Nichols, 2016 #854},"
                   ...
                   f"curiously the area with lowest transcription of Htr1f, otherwise highly prevalent in all other cortical regions. Htr2a was also minimally expressed in this specific area. "
           ...
           "Htr4, Htr6 and Htr7": "These receptors are all connected to Gs {McCorvy, 2015 #2889}, leading to increasing cellular levels of cAMP. "
                                  ...
                                  f"transcribing the RNA of this gene were excitatory cortical neurons (Supplementary Figure 11C). \n"
