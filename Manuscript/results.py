...
results = {"Htrs transcription overview":
               ...
               "i.e., to be classified as enriched at least {threshold_enriched_clusters}% of cells in a given"
              "a cluster must express the selected Htr gene. Taking advantage of the clustering label integration between the scRNA-seq and "
           ...
           "Htr1 & Htr5": u"Receptors belonging to these two families have an inhibitory effect on the host cell, they are coupled to G\u1D62 and cause a downstream decrease of cAMP "
                          ...
                          "Htr1b is involved in social memory persistaence in mouse {Wu, 2021 #2945}. Htr1b exhibited a more diverse pattern of transcription across neighborhoods (Figure 3A) ranging from 10 to 30%. "
