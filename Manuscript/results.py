...
results = {"Htrs transcription overview":
           ...
           "Htr1 & Htr5": u"Receptors belonging to these two families have an inhibitory effect on the host cell, they are coupled to G\u1D62 and cause a downstream decrease of cAMP "
                          ...
                          "a cluster must express the receptor. Taking advantage of the clustering label integration between the scRNAseq and MERFISH dataset (see {Zhang, 2023 #2887}), "
                          ...
                          "of all cells expressing the selected gene in the MERFISH dataset using the interactive visualizer (see 'Overview genes by brain structure'). \n"
           ...
           "Htr4, Htr6 and Htr7": "These receptors are all connected to Gs {McCorvy, 2015 #2889}, leading to increasing cellular levels of cAMP. Htr4 modulation in HPF has been found to "
                                  ...
                                  "(Figure 8C). Cortical expression in excitatory neurons is driven primarily by subclasses in CA2 and L2 ENT (see interactive visualizer, 'Overview genes by class'). "
