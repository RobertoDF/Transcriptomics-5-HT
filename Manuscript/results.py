...
results = {"Transcriptomic overview of 5-HT receptors landscape":
               ...
               f"{at_least_2_receptors_per_group.loc['MB-HB-Glut-Sero-Dopa']} %). The average excluding non neuronal cells was {round(at_least_2_receptors_per_group.drop('NN-IMN-GC').mean(), 2)}±{round(at_least_2_receptors_per_group.drop('NN-IMN-GC').sem(), 2)} %. "
