...
results = {"Transcriptomic overview of 5-HT receptors landscape":
               ...
               f"{'-'.join(corr_by_cell.index[2])} (r={corr_by_cell.sort_values(ascending=False).iloc[2]}) pairs (Figure 1E). Interestingly, correlation patterns were not stable across neighboroods "
               ...
               f" a uniquely low Htr7 colocalization ({coloc_matrix.loc['Htr7', 'Pallium-Glut']}%) on the other hand, TH-EPI-Glut showed the highest ({coloc_matrix.loc['Htr7', 'TH_EPI_Glut']}%).  "
