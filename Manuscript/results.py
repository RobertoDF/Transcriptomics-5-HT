...
results = {"Htrs transcription overview":
               ...
               f"Across the entire dataset we observed that the most transcribed genes, Htr1f and Htr2c, were often colocalized with other genes (Figure 1G). "
               ...
               f"of cells indeed transcribed at least "
               f"2 Htrs (Figure 1F), therefore, only rarely a cell was found to express uniquely one Htr. Surprisingly, {round(at_least_5_receptors.mean().values[0], 2)}±{round(at_least_5_receptors.sem().values[0], 2)}% of cells transcribed at least 5 Htrs. "
               f"The extensive transcription across different Htr classes and the considerable cotranscription within cells point at the complexity of the 5-HT system even "
           ...
           "Htr1 & Htr5": u"Receptors belonging to these two families have an inhibitory effect on the host cell, they are coupled to G\u1D62 and cause a downstream decrease of cAMP "
                          ...
                          f"significantly lower (Figure 4C). The two datasets are, however, still highly correlated, with 66% of shared variability. Htr1f was broadly transcribed across almost all classes, "
           ...
           "Htr2": "The Htr2 family is mainly linked to Gq/11 and causes excitation by increasing intracellular Ca2+. Htr2a, famous for being instrumental in mediating the effects of psychedelics {Nichols, 2016 #854},"
                   ...
                   "and 16 HY-MM Glut classes (Figure 5C). Htr2a was also prevalent across many other classes across the whole brain. 01 IT-ET Glut exhibited by far the highest absolute number "
                   "of neurons transcribing Htr2a, specifically in subclasses of L5 and CLA. Interestingly, "
                   "Similarly to Htr1f, also here the MERFISH dataset hinted at a lower overall transcription when compared to RNA-seq. "
                   ...
                   "important role in mediating the effects of psychedelic compounds {Doss, 2022 #2917}. Prevalence in the STR was driven almost single-handedly by the bed nucleus (BA), a structure important for the "
                   "integration of limbic and enviromental informations {Lebow, 2016 #2931}. Htr2a transcription in CLA and mammillary complex is in line with a previous report in monkey{López-Giménez, 2001 #2930}. "
                   ...
                   f"transcription was broadly distributed across many different classes, also subcortically. "
                   ...
                   f"unique transcription in excitatory neurons of the ventral part of the retrosplenial cortex (RSPv), "
           ...
           "Htr4, Htr6 and Htr7": "These receptor are all connected to Gs {McCorvy, 2015 #2889}, leading to increasing cellular levels of cAMP. "
                                  ...
                                  "Discrepancies in amount of transcription between RNA-seq and MERFISH were present also here (Figure 7C). "
                                  "This did not affect significantly, however, the correlation between the two datasets. "
                                  "transcription across classes was broadly distributed, with many classes showing a prevalence >40%. Highest prevalence was found in "
                                  "the 17 MH-LH Glut class, specifically in the Chol releasing neurons of this class located in TH. "
                                  "In absolute numbers, transcription in excitatory cortical neurons was comparable to other classes. "
                                  ...
                                  "Colocalization was the highest with Htr2c and Htr1f (Figure 8B). transcription was broadly distributed across classes present in HY, MB and TH (Figure 8C). It colocalized the most with Htr2c, "
                                  "tr1f and Htr4. Htr7 was broadly transcribed across classes, especially in subcortical structures. Peak prevalence was found in 10 LSX GABA and 16 Y MM Glut with >60%. "
