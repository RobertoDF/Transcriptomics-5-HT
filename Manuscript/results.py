...
results = {"Transcriptomic overview of 5-HT receptors landscape":
               "We analysed the single-cell RNA-sequencing (scRNA-seq) dataset provided by Allen Institute {Yao, 2023 #2828} "
                ...
                f"14 Htrs. Prevalence of Htrs across the entire dataset was considerably different ranging from {expression_total.min()}% of {expression_total.idxmin()} "
               ...
               f"Neighborhoods were defined both yby location and neurotransmitter (Supplementary Figure #). "
               f"Distribution within family also showed considerable differences (Supplementary Figure #). "
               f"Htrs distribution was also markedly different when dividing cells according to the "
               f"released neurotransmitter (Figure 1C). Cells not found to express any transmitter made out {total_cells_by_neurotransmitter['']}% of the total (Supplementary Figure #) and "
               f"were the only group that did not express significant (mean prevalence = {round(expression_by_neurotransmitter.T[''].mean(),2)}±{round(expression_by_neurotransmitter.T[''].sem(),2)}%) "
               f"amounts of any Htrs. All other groups expressed significant amounts of at least 2 different Htrs. "
               ...
               f"in particular, 5-HT releasing neurons  were found in only {total_cells_by_neurotransmitter['Sero']}% of the cells. "
               f"5-HT neurons expressed at high levels the highest variety of Htrs. They showed "
               ...
               f"and Htr7 ({expression_by_neurotransmitter['Htr7']['Sero']}%). In total, 5-HT neurons showed significant expression (prevalence >20%) of 8 different Htrs. GABA-Glyc neurons, constituting only "
