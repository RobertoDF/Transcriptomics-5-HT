...
results = {"Transcriptomic overview of 5-HT receptors landscape":
               ...
               f"Neighborhoods were defined both by location and neurotransmitter (Supplementary Figure 1B). "
               ...
               f"{'-'.join(corr_by_cell.index[2])} (Pearson coefficient={corr_by_cell.sort_values(ascending=False).iloc[2]}) pairs (Figure 1E). Effect of this correlation was also visible "
               f"when looking at co-expression (Figure 1F). Expectedly, Htr1f and Htr2c, the most prevalent Htrs, were found to co-localize with other receptors respectevely {mean_coloc['Htr1f']}% "
               ...
               f"of the 5-HT system even at a single cell level. "
               f"The extensive expression across different classes and the considerable coexpression within cells point at the complexity of the 5-HT system. To facilitate an understanding of the downstream  cellular effects "
               f"of 5-HT we aggregated receptors according to their main intracellular effect. We aggregated Htr1 and Htr5 due to their inhibitory effect (cAMP decrerase), Htr4, Htr6 and Htr7 because "
               ...
               f"In the cortex, the absolute majority of both Pallium-Glut "
               f"and Subpallium-Gaba cells were linked to Htr1/5, around one quarter of cells instead featured Htr2 at the highest level. Subcortical cells exhibited a more balanced division without an "
               f"absolute majority. Ht3 were present in a small minority of only cortical inhibitory neurons. "
               f" In the following sections we will take a deeper look at "
               "Htrs grouped by effector, we will take advantage of the spatial information provided by the MERFISH dataset of {Zhang, 2023 #2887} regarding 9 Htrs. "
