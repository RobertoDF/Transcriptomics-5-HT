...
"Supplementary Figure 6. Htr5a transcription": f"(A) On the left, Htr5a prevalence across neighborhoods with squared Pearson correlation coefficient (R²) between RNA-seq and MERFISH dataset. On the right, amount of Htr5a RNA detected using "
                                              f"RNA-seq (top) and MERFISH (bottom). "
                                              f"(B) Amount of colocalization with each Htrs by cells expressing Htr5a RNA (left). Number of Htrs RNA detected in cells "
...
"Supplementary Figure 7. Htr5b transcription": f"(A) On the left, Htr5b prevalence across neighborhoods with squared Pearson correlation coefficient (R²) between RNA-seq and MERFISH dataset. On the right, amount of Htr5b RNA detected using "
                                              f"RNA-seq (top) and MERFISH (bottom). "
                                              f"(B) Amount of colocalization with each Htrs by cells expressing Htr5b RNA (left). Number of Htrs RNA detected in cells "
...
"Supplementary Figure 8. Htr2b transcription": f"(A) On the left, Htr2b prevalence across neighborhoods with squared Pearson correlation coefficient (R²) between RNA-seq and MERFISH dataset. On the right, amount of Htr2b RNA detected using "
                                              f"RNA-seq (top) and MERFISH (bottom). "
                                              f"(B) Amount of colocalization with each Htrs by cells expressing Htr2b RNA (left). Number of Htrs RNA detected in cells "
...
"Supplementary Figure 9. Htr6 transcription": f"(A) On the left, Htr6 prevalence across neighborhoods with squared Pearson correlation coefficient (R²) between RNA-seq and MERFISH dataset. On the right, amount of Htr6 RNA detected using "
                                              f"RNA-seq (top) and MERFISH (bottom). "
                                              f"(B) Amount of colocalization with each Htrs by cells expressing Htr6 RNA (left). Number of Htrs RNA detected in cells "
...
"Supplementary Figure 10. Htr3a transcription": f"(A) On the left, Htr3a prevalence across neighborhoods with squared Pearson correlation coefficient (R²) between RNA-seq and MERFISH dataset. On the right, amount of Htr3a RNA detected using "
                                              f"RNA-seq (top) and MERFISH (bottom). "
                                              f"(B) Amount of colocalization with each Htrs by cells expressing Htr3a RNA (left). Number of Htrs RNA detected in cells "
...
"Supplementary Figure 11. Htr3b transcription": f"(A) On the left, Htr3b prevalence across neighborhoods with squared Pearson correlation coefficient (R²) between RNA-seq and MERFISH dataset. On the right, amount of Htr3b RNA detected using "
                                              f"RNA-seq (top) and MERFISH (bottom). "
                                              f"(B) Amount of colocalization with each Htrs by cells expressing Htr3b RNA (left). Number of Htrs RNA detected in cells "
