...
legends_supplementary =  {
    "Figure S1. Htrs transcription and hierarchical clustering visualization.":
                "(A) Top: Linear regression model fit between prevalence (y axis) and amount of intracellular expression (x axis) for each Htrs. Bottom: violin plots "
                ...
                "(C) Bar plots representing the size of each group when cells are categorized by neurotransmitter (top), neighborhood (middle) and class (botttom). ",
...
"Figure S5. Htr1d transcription": f"(A) On the left, Htr1d prevalence across neighborhoods with squared Pearson correlation coefficient (R²) between scRNA-seq and MERFISH dataset. On the right, amount of Htr1d RNA detected using "
                                              ...
                                              f"(C) Prevalence of Htr1d RNA across all classes of cells in scRNA-seq and MERFISH dataset. Inset represents the linear regression between the two datasets. "
                                              f"On the right, absolute number of cells expressing Htr1d RNA by class ranked in descending order (top ten). "
...
"Supplementary Figure S6. Htr5a transcription": f"(A) On the left, Htr5a prevalence across neighborhoods with squared Pearson correlation coefficient (R²) between scRNA-seq and MERFISH dataset. On the right, amount of Htr5a RNA detected using "
                                              f"scRNA-seq (top) and MERFISH (bottom). "
                                              ...
                                              f"(C) Prevalence of Htr5a RNA across all classes of cells in scRNA-seq and MERFISH dataset. Inset represents the linear regression between the two datasets. "
                                              f"On the right, absolute number of cells expressing Htr5a RNA by class ranked in descending order (top ten). "
...
"Figure S7. Htr5b transcription": f"(A) On the left, Htr5b prevalence across neighborhoods with squared Pearson correlation coefficient (R²) between scRNA-seq and MERFISH dataset. On the right, amount of Htr5b RNA detected using "
                                              f"scRNA-seq (top) and MERFISH (bottom). "
                                              ...
                                              f"(C) Prevalence of Htr5b RNA across all classes of cells in scRNA-seq and MERFISH dataset. Inset represents the linear regression between the two datasets. "
                                              f"On the right, absolute number of cells expressing Htr5b RNA by class ranked in descending order (top ten). "
...
"Supplementary Figure S8. Htr2b transcription": f"(A) On the left, Htr2b prevalence across neighborhoods with squared Pearson correlation coefficient (R²) between scRNA-seq and MERFISH dataset. On the right, amount of Htr2b RNA detected using "
                                              f"scRNA-seq (top) and MERFISH (bottom). "
                                              ...
                                              f"(C) Prevalence of Htr2b RNA across all classes of cells in scRNA-seq and MERFISH dataset. Inset represents the linear regression between the two datasets. "
                                              f"On the right, absolute number of cells expressing Htr2b RNA by class ranked in descending order (top ten). ",
    
"Figure S9. Htr6 transcription": f"(A) On the left, Htr6 prevalence across neighborhoods with squared Pearson correlation coefficient (R²) between scRNA-seq and MERFISH dataset. On the right, amount of Htr6 RNA detected using "
                                              f"scRNA-seq (top) and MERFISH (bottom). "
...
"Figure S11. Htr3b transcription": f"(A) On the left, Htr3b prevalence across neighborhoods with squared Pearson correlation coefficient (R²) between scRNA-seq and MERFISH dataset. On the right, amount of Htr3b RNA detected using "
                                              ...
                                              f"(C) Prevalence of Htr3b RNA across all classes of cells in scRNA-seq and MERFISH dataset. Inset represents the linear regression between the two datasets. "
                                              f"On the right, absolute number of cells expressing Htr3b RNA by class ranked in descending order (top ten). ",
...
"Table 3. Htrs defining features": f"Table listing the defining feature of each Htr trascription pattern. ",
