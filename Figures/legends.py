...
legends =  {"Figure 1. Overview of Htrs translation.":
                ...
                "(D) Htr expression prevalence in cells grouped by class. "
...
legends.update({f"Figure {n+2}. {gene} transcription": f"(A) On the left, dot plot representing {gene} prevalence across neighborhoods with squared Pearson correlation coefficient (R²) between scRNA-seq "
                                                       f"and MERFISH dataset. On the right, violin plots representing the amount of {gene} RNA detected using "
                                              ...
                                              f"(C) Prevalence of {gene} RNA across all classes of cells in scRNA-seq and MERFISH dataset. Inset represents the linear regression between the two datasets. "
                                              f"On the right, absolute number of cells expressing {gene} RNA in the scRNAseq by class, ranked in descending order (top ten). "
